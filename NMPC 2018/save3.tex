...
\subfloat[At time step t=14]{\includegraphics[width=7cm]{plot/2_1_1.eps}}
\hspace{0.5cm}
\subfloat[At time step t=15]{\includegraphics[width=7cm]{plot/2_1_2.eps}}
\hspace{0.5cm}
\subfloat[At time step t=19]{\includegraphics[width=7cm]{plot/2_1_3.eps}}
\hspace{0.5cm}
...
\begin{figure}[htbp]
\begin{center}
\subfloat[At time step t=14]{\includegraphics[width=7cm]{plot/3_1_1.eps}}
\hspace{0.5cm}
\subfloat[At time step t=15]{\includegraphics[width=7cm]{plot/3_1_2.eps}}
\hspace{0.5cm}
\subfloat[At time step t=27]{\includegraphics[width=7cm]{plot/3_1_3.eps}}
\hspace{0.5cm}
...
\begin{figure}[htbp]
\begin{center}
\subfloat[At time step t=16]{\includegraphics[width=7cm]{plot/3_3_1.eps}}
\hspace{0.5cm}
\subfloat[At time step t=21]{\includegraphics[width=7cm]{plot/3_3_2.eps}}
\hspace{0.5cm}
\subfloat[At time step t=27]{\includegraphics[width=7cm]{plot/3_3_3.eps}}
\hspace{0.5cm}
